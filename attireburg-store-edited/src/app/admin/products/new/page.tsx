...
// DEMO_MODE: Save buttons disabled. Set to false to re-enable product creation.
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              title={DEMO_MODE ? 'Nicht verfügbar im Design-Modus' : ''}
              onClick={() => !DEMO_MODE && handleSave('draft')}
              className="px-4 py-2 border border-gray-300 rounded-lg text-gray-400 cursor-not-allowed opacity-50"
            >
            ...
            <button
              disabled={DEMO_MODE || loading}
              title={DEMO_MODE ? 'Nicht verfügbar im Design-Modus' : ''}
              onClick={() => !DEMO_MODE && handleSave('published')}
